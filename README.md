...
<p align="center"><img width=100% alt="Logo" src="./pictures/wavcrc32.svg"></p>
...
* [Windows](#Windows)
* [Linux](#Linux)
  * [Установка/Удаление wavcrc32 с помощью пакетного менеджера](#Удаление-wavcrc32-с-помощью-пакетного-менеджера)
  * [Установка/Удаление wavcrc32 вручную](#Удаление-wavcrc32-вручную)
* [MacOS (Intel)](#MacOS-Intel)
  ...
  * [Установка/Удаление wavcrc32 вручную](#Установка/Удаление-wavcrc32-вручную)
